				...
				while($row_user = mysqli_fetch_array($run_user))
				{
					...
					echo"
						<div class='container_fluid'>
							<a style='text-decoration: none; cursor: pointer; color: purple;' href='messages.php?u_id=$user_id'>
					...
					while($row_msg = mysqli_fetch_array($run_msg))
					{
						...
						<div id="loaded_msg">
							<p><?php  
									...
									{
										echo"<div class='messgae' id='green' data-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";
									}?></p>
						</div>
					...
					if(isset($_GET['u_id']))
					{
						...
						if($u_id == "new")
						{
							echo'
								...
								<form>
									<center><h3>Select Someone to a Conversation With</h3></center>
		...
		<div class="col-sm-3">
				...
				if(isset($_GET['u_id']))
			{
				...
				echo"<div class='row'>
					...
					<center>
					<div style='background-color: red;' class='col-sm-9'>
